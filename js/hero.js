...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Cloudinary logo image + brand name
  logo.innerHTML =
    '<img class="site-logo-img" src="https://res.cloudinary.com/dbrzpkme5/image/upload/v1766069991/Copy_of_ADITYA_3_usm28g.png" alt="Aditya Enterprises logo" />' +
    '<span class="site-logo-text">Aditya Enterprises</span>';
